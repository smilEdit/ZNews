...
/**
 * @创建者 zlf
 * @创建时间 2016/9/29 14:17
 */

public class RobotLeftItem implements ItemViewDelegate<RobotTalkBean> {

    @Override
    public int getItemViewLayoutId() {
        return R.layout.item_robot_left;
    }
    ...
    public void convert(ViewHolder holder, RobotTalkBean bean, int position) {
        holder.setText(R.id.tv_robot_left, bean.getContent())
                .setImageResource(R.id.iv_robot_left, bean.getIcon());
    }
}
